...
public class Parser
{
	...
	/**
	 * Adds a mutable tree node based on
	 * {@code tokens.get(currentToken).getWord()} to the {@code toParent}
	 * parameters and returns the {@code node} object that was added.
	 * 
	 * @param toParent
	...
	/**
	 * Adds a mutable tree node with the {@code nodeDescription} to the
	 * {@code toParent} parameter and returns the {@code node} object that was
	 * added.
	 * 
	...
	/**
	 * Adds a mutable tree node, which represents the {@code error} parameter, to
	 * the {@code toParent} parameter and returns the {@code node} object that
	 * was added.
	 * 
	 * @param error
	 * @param toParent
	...
	/**
	 * Determines if the currentWord that the parser is iterating over is equal
	 * to the parameter string.<br/>
	...
	/**
	 * Determines if the currentToken that the parser is iterating over is equal
	 * to the parameter string.<br/>
	...
	/**
	 * Determines if the currentToken is <strong>not</strong> on the same line as
	 * the last.<br/>
	...
	/**
	 * Determines if the currentToken that the parser is iterating over is one
	...
	/**
	 * Determines if the currentWord that the parser is iterating over is one
	 * which represents a data type.
	 * 
	 * @return boolean
	 */
	...
	/**
	 * Prints out an error message based on the parameter {@code error} of the
	 * specified {@code previousToken}.<br/>
	 * 
	 * @see {@link ParserError}
	 * @param error
	 */
	...
	/**
	 * Determines if the current token matches the expected value, as defined in
	 * the <strong>first set</strong>, of the parameter {@code rule}
	 * 
	 * @param rule
	 * @return boolean
	 */
	...
	/**
	 * Determines if the current token matches the expected value, as defined in
	 * the <strong>follow set</strong>, of the parameter {@code rule}
	 * 
	 * @param rule
	 * @return boolean
	 */
	...
	/**
	 * A basic enumerator class that lists all of the rules that are defined in
	 * the parser.
	 * 
	 * @see Parser
	 * @author Jan Christian Chavez-Kortlang
	...
	private enum Rule
	{
		Program, Body, Assignment, Variable, While, If, Return, Print, Expression, X, Y, R, E, A, B, C;
	}

	/**
	 * Enumerator class that contains all of the syntax errors that the parser
	 * may encounter. Every enumerator contains a string that describes the
	 * expected word(s) of each error.
	 * 
	 * @author Jan Christian Chavez-Kortlang
	 */
	private enum ParserError
	{
		OpeningCurly("{"), ClosingCurly("}"), OpeningParenthesis("("), ClosingParenthesis(")"), SemiColon(";"), Equals("="), ID("identifer"), ID_Keyword(
		      "identifer or keyword"), ID_Value_OpenParenthesis("value, identifier, (");
